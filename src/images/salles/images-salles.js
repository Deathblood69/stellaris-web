...
export const IMAGES_SALLES = {
  aquatique: aquatics_room,
  defaut: default_room,
  doree: gilded_room,
  lithoide: lithoid_room,
  machine: machine_room,
  necroide: necroids_room,
  organique: organic_room,
  hierachie_decadente: personality_decadent_hierarchy_room,
  croises_democratique: personality_democratic_crusaders_room,
  explorateurs_erudits: personality_erudite_explorers_room,
  evangelists_fanatiques: personality_evangelizing_zealots_room,
  fanatiques_amicals: personality_fanatic_befrienders_room,
  purificateurs_fanatiques: personality_fanatic_purifier_room,
  federateurs: personality_federation_builders_room,
  hierachie_harmornieuse: personality_harmonious_hierarchy_room,
  hegemonie_imperialiste: personality_hegemonic_imperialists_room,
  conscience_collective: personality_hive_mind_room,
  guerriers_valeureux: personality_honorbound_warriors_room,
  constructeurs_federations: personality_metalheads_room,
  nomades: personality_migrating_flock_room,
  commercants_pacifiques: personality_peaceful_traders_room,
  capitalistes_impitoyables: personality_ruthless_capitalists_room,
  esclavagistes: personality_slaving_despots_room,
  chercheurs_spiritualistes: personality_spiritual_seekers_room,
  xenophobes_isolationiste: personality_xenophobic_isolationists_room,
  runique: runic_room,
  ruine: scrappy_room,
